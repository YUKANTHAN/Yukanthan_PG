...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Yukanthan 👋 Ask me anything you want to know!' }
  ]);
        ...
        <div className="chess-board-section">
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar" style={{ fontWeight: "bold", color: "#fb8dff" }}>
                Y
              </div>
              <div className="player-details">
                <span className="player-name">Yukanthan</span>
